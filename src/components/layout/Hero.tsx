    ...
    <section className="bg-gradient-to-r from-white to-blue-50 dark:from-gray-900 dark:to-gray-800 py-10 sm:py-16 md:py-20">
      <div className="section-container px-4 sm:px-6 lg:px-8">
        <div className="text-center lg:text-left lg:grid lg:grid-cols-12 lg:gap-8 items-center">
          ...
          >
            ...
            <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row sm:justify-center lg:justify-start gap-3 sm:gap-4">
              <div className="rounded-md shadow">
                <a href="#contact" className="btn-primary flex items-center justify-center w-full sm:w-auto px-6 py-3">
                  Sell My Licenses
                </a>
              </div>
              <div>
                <a href="#how-it-works" className="btn-secondary flex items-center justify-center w-full sm:w-auto px-6 py-3">
                  Learn How
                </a>
              </div>
            </div>
          ...
          >
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 sm:p-8 mx-auto max-w-sm lg:max-w-none">
